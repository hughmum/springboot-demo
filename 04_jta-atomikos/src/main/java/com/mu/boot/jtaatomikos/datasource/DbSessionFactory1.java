package com.mu.boot.jtaatomikos.datasource;

import com.atomikos.jdbc.AtomikosDataSourceBean;
import com.mu.boot.jtaatomikos.config.DB1Config;
...
@Configuration
@MapperScan(basePackages = {"com.mu.boot.jtaatomikos.mapper.db1"}, sqlSessionFactoryRef = "sqlSessionFactoryDb1")
