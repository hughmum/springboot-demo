package com.mu.boot.databaselook.point;

import com.mu.boot.databaselook.model.MethodLock;
import com.mu.boot.databaselook.repository.MethodLockRepository;
...
public class TaskPointcut {
     ...
     */
    @Pointcut("execution(public * com.mu.boot.databaselook.controller.OrderController.*(..)))")
    //@Pointcut("execution(public * com.mu.boot.databaselook.task.ScheduledTask.task1())")
