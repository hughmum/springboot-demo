package com.mu.boot.mybatisplus.generator;
...
import com.mu.boot.mybatisplus.entity.BaseEntity;
...
public class GeneratorMybatisCode {
    ...
    //生成类的作者描述
    private final static String AUTHOR = "Mr.yuan";
    //数据库连接信息
    ...
    //项目包名全路径
    private final static String BASE_PACKAGE = "com.mu.boot.mybatisplus";
