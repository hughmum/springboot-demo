package com.mu.boot.distributedjob.pointcut;

import com.mu.boot.distributedjob.annotation.RedisLock;
...
public class RedisLockPointcut {
    ...
    @Pointcut("@annotation(com.mu.boot.distributedjob.annotation.RedisLock)")
